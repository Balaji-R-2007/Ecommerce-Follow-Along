...
const handlePlaceOrder = async (paymentType = 'cod', paypalOrderData = null) => {
    try {
            ...
            const response = await axios.post('http://localhost:8000/api/v2/order/place-order', payload);
                        ...
                        {paymentMethod === 'paypal' && (
                            <div className='mt-4' style={{ maxWidth: '500px' }}>
                                <PayPalScriptProvider
                                    options={{
                                        'client-id': 'AXSaHscj4l4MdVnI_-0nlq6_67UJeWIoGbP3EujWHWHU_MffgTxNg845pcGKENYKldoaYF4v14px8DDN', 
                                    }}
                                >
                                    <PayPalButtons
